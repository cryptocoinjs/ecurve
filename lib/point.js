...
var integerToBytes = util.integerToBytes
...
ECPointFp.decodeFrom = function(curve, enc) {
  ...
  if (!compressed) {
    assert.equal(enc.length, 65, 'Invalid sequence length')
    ...
    assert.equal(enc.length, 33, 'Invalid sequence length')
  ...
  //TODO: maybe add compressed flag?
